...
const translations = {
  en: {
    ...
    school_name: "SASS International School", school_address: "Bole Road, Addis Ababa, Ethiopia",
  ...
  am: {
    ...
    school_name: "SASS ዓለም አቀፍ ትምህርት ቤት", school_address: "ቦሌ መንገድ፣ አዲስ አበባ፣ ኢትዮጵያ",
  ...
  om: {
    ...
    school_name: "SASS Mana Barnootaa Idil-addunyaa", school_address: "Daandii Bolee, Finfinnee, Itoophiyaa",
